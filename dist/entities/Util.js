...
var play_dl_1 = __importDefault(require("@iamtraction/play-dl"));
...
var Util = /** @class */ (function () {
    function Util(api) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        username = String(resolvable.match(/(c\/)(.*?)(?=(?:\?|\/|$))/)[0].replace("c/", ""));
                    ...
                    case 3:
                        ...
                        username = String(resolvable.match(/(user\/)(.*?)(?=(?:\?|\/|$))/)[0].replace("user/", ""));
                    ...
                    case 7:
                        ...
                        return [3 /*break*/, 10];
                    case 8:
                        query = String(resolvable.match(/(youtube.com\/)(.*?)(?=(?:\?|$))/)[0].replace("youtube.com/", ""));
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        headers = {
                            ...
                            "referer": "https://studio.youtube.com/video/".concat(id, "/edit?utm_campaign=upgrade&utm_medium=redirect&utm_source=%2Fmy_videos"),
                    ...
                    case 2:
                        ...
                        if (dest.endsWith("/"))
                            dest = dest.slice(0, -1);
                        dest = "".concat(dest, "/").concat(filename);
        ...
        this.downloadVideo = function (videoResolvable, dest, downloadOptions) { return __awaiter(_this, void 0, void 0, function () {
            var height, fps, format, _a, resolution, framerate, local, command, child, title;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        height = "1080";
                        fps = "30";
                        format = "mp4";
                        if (downloadOptions === null || downloadOptions === void 0 ? void 0 : downloadOptions.format)
                            format = downloadOptions.format;
                        if (downloadOptions === null || downloadOptions === void 0 ? void 0 : downloadOptions.quality) {
                            _a = __read(downloadOptions.quality.split("p"), 2), resolution = _a[0], framerate = _a[1];
                        ...
                        command = (downloadOptions === null || downloadOptions === void 0 ? void 0 : downloadOptions.ytDlpPath) ? downloadOptions.ytDlpPath : "yt-dlp";
                        child = child_process_1.default.exec("".concat(command, " -f \"ba+bv[height=").concat(height, "][fps=").concat(fps, "]\" --merge-output-format ").concat(format, " -o \"").concat(dest, "/%(title)s.%(ext)s\" \"").concat(videoResolvable, "\""));
                        title = "";
                        return [4 /*yield*/, new Promise(function (resolve) {
                                child.stdout.on("data", function (chunk) {
                                    var _a;
                                    if (chunk.includes("Merging formats"))
                                        title = (_a = chunk.match(/(?<=")(.*?)(?=")/)) === null || _a === void 0 ? void 0 : _a[0];
                                });
                    ...
                    case 1:
                        _b.sent();
                        return [2 /*return*/, "".concat(dest, "/").concat(title)];
                }
            });
        }); };
        ...
        this.downloadMP3 = function (url, dest, downloadOptions) { return __awaiter(_this, void 0, void 0, function () {
            var format, local, title, stream, output;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        format = "mp3";
                    ...
                    case 1:
                        title = _a.sent();
                        return [4 /*yield*/, play_dl_1.default.stream(url)];
                    case 2:
                        stream = _a.sent();
                        output = path_1.default.extname(dest) ? dest : path_1.default.join(dest, "".concat(title, ".").concat(format));
                        ...
                        return [2 /*return*/, new Promise(function (resolve) {
                                stream.stream.pipe(fs_1.default.createWriteStream(output))
                                    .on("finish", function () { return resolve(output); });
                            })];
                }
            });
        }); };
        ...
        this.streamMP3 = function (videoResolvable) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        id = _a.sent();
                        url = "https://www.youtube.com/watch?v=".concat(id);
                        return [4 /*yield*/, play_dl_1.default.stream(url)];
                    case 2:
                        stream = _a.sent();
        ...
        this.downloadThumbnail = function (videoResolvable, folder, noDL) { return __awaiter(_this, void 0, void 0, function () {
            var id, url, thumbnail, title, dest, arrayBuffer;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!folder)
                    ...
                    case 1:
                        id = _a.sent();
                        url = "https://www.youtube.com/watch?v=".concat(id);
                        return [4 /*yield*/, this.getThumbnailSrc(url)];
                    case 2:
                        thumbnail = _a.sent();
                        return [4 /*yield*/, this.getTitle(url)];
                    case 3:
                        ...
                        dest = path_1.default.join(folder, "".concat(title, ".png"));
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        id = _b.sent();
                        url = "https://www.youtube.com/watch?v=".concat(id);
                        return [4 /*yield*/, axios_1.default.get(url, { headers: { "user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36" } }).then(function (r) { return r.data; })];
                    case 2:
                        html = _b.sent();
                        return [2 /*return*/, ((_a = html.match(/(?<=meta name="title" content=")(.*?)(?=")/)) === null || _a === void 0 ? void 0 : _a[0]) || ""];
                }
            });
        }); };
        /**
         ...
         */
        this.getThumbnailSrc = function (videoResolvable) { return __awaiter(_this, void 0, void 0, function () {
            var id, url, html;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        html = _b.sent();
                        return [2 /*return*/, ((_a = html.match(/(?<=meta property="og:image" content=")(.*?)(?=")/)) === null || _a === void 0 ? void 0 : _a[0]) || ""];
                }
            });
        }); };
    }
